...
function Login() {
  ...
  const forSignUp = (e) => {
    e.preventDefault();
    if (
      inpConfirmPass === inpPass &&
      Email.test(inpEmail) &&
      Password.test(inpPass)
    ) {
      axios
        .post(`/auth/sign-up`, {
    ...
    <>
      <div className={cx("login")}>
        ...
        >
          ...
          <h2>
            or{" "}
            <span className={cx("change")} onClick={toSignUp}>
              SignUp
            </span>
          </h2>
        </form>
        ...
        >
          ...
          <button className={cx("bnt-signup")}>SignUp</button>
          <h2>
            or{" "}
            <span className={cx("change")} onClick={toLogIn}>
              LogIn
            </span>
          </h2>
        </form>
